...
const Home = () => {
  ...
  /* Use user status to not show login button if user is not authenticated */
  if (status === 'loading') {
    return null;
  }
            ...
            <Col md={6}>
              <Card className="bg-transparent border-0">
                ...
                <Card.Body className={`${lato.className} text-start fs-5`}>
                  ...
                  sustainability on campus. Join us in our mission to create a more sustainable future for our
                  community.
                </Card.Body>
                ...
                <Container>
                  <Card className="h-100 bg-transparent border-0">
                    ...
                    <Card.Body className={`${lato.className} fs-5`}>
                      We aim to reduce food waste island wide by providing a secure platform for the UH Manoa community
                      to share unused or unwanted food items, promoting sustainability even beyond our campus.
                    </Card.Body>
                  </Card>
                ...
                <Container>
                  <Card className="h-100 bg-transparent border-0">
                    ...
                    <Card.Body className={`${lato.className} fs-5`}>
                      ...
                      interested in. Claim the food and arrange a pickup with the user who listed it. Earn points for
                      each food item you claim!
                    </Card.Body>
                  </Card>
                  <p className="text-start" />
                </Container>
